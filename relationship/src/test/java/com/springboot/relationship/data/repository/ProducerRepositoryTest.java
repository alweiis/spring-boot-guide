...
class ProducerRepositoryTest {
    ...
    void relationshipTest() {
        ...
        Product product2 = saveProduct("공책", 100, 2000);
        Product product3 = saveProduct("지우개", 150,  500);

        Producer producer1 = saveProducer("sun");
        Producer producer2 = saveProducer("moon");
